...
public:
  ...
  {
    color_sub_.subscribe(*this, "/camera/color/image_raw", "raw", rclcpp::QoS(10));
    depth_sub_.subscribe(*this, "/camera/aligned_depth_to_color/image_raw", "raw", rclcpp::QoS(10));
    info_sub_.subscribe(this, "/camera/color/camera_info", rclcpp::QoS(10));
